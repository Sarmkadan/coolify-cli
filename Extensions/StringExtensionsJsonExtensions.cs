...
public static class StringExtensionsJsonExtensions
{
    ...
    public static string ToJson(this string value, bool indented = false)
    {
        ...
        var options = indented
            ? new System.Text.Json.JsonSerializerOptions(_jsonSerializerOptions)
            {
                WriteIndented = true
            }
    ...
    public static string? FromJson(string json)
    {
        ...
        return System.Text.Json.JsonSerializer.Deserialize<string>(json, _jsonSerializerOptions);
    }
